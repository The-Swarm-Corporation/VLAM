...
class TestExamples:
    ...
    def test_model_description_api(self):
        ...
        # Check required keys
        required_keys = [
            'robot_type', 'action_dimension', 'action_bounds', 
            'joint_names', 'model_parameters', 'trainable_parameters'
        ]
    ...
    def test_inference_modes(self):
        ...
        assert train_outputs['language_logits'].shape == eval_outputs['language_logits'].shape
        ...
        assert torch.allclose(eval_outputs['language_logits'], eval_outputs2['language_logits'])
